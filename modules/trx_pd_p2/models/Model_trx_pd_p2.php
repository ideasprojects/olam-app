...
class Model_trx_pd_p2 extends MY_Model {
    ...
    public function join_avaiable() {
        ...
        $this->db->where('trx_pd_all.data_source', 'powder_plant_2');
        if($tanggal_awal) {
...
/* End of file Model_trx_pd_p2.php */
/* Location: ./application/models/Model_trx_pd_p2.php */