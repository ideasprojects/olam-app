                  ...
                  <?= form_open(base_url('administrator/user/edit_save/'.$this->uri->segment(4)), [
                   ...
                   <div class="form-group ">
                    ...
                    <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="department_id" id="department_id" data-placeholder="Select Name" >
                                    <option value=""></option>
                                    <?php foreach (db_get_all_data('aauth_users_department') as $row): ?>
                                    <option <?=  $row->id ==  $user->department_id ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                              <!--   <small class="info help-block">
