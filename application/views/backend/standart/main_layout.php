...
<head>
  ...
  <!-- custom -->
  <script src="<?= BASE_ASSET; ?>/js/echarts.min.js"></script>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= site_url('/administrator/dashboard'); ?>" class="logo">
      <span class="logo-mini"><b><img src="<?= BASE_ASSET ?>img/icon-olam.png" height="40px"></b></span>
      <span class="logo-lg"><b><img src="<?= BASE_ASSET ?>img/logo-olam.png" height="40px"></b></span>
    </a>
